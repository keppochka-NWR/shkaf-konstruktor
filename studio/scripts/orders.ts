...
export const orders: Record<string, { title: string; note: string; project: Project }> = {
  ...
  "5-shain": {
    title: "6724055 Шаин — прихожая со скосом фронта 15°",
    note: "Дуб Сонома Lamarty, фасады Evogloss 18 (в каталоге нет — взят Белый). Фронт композиции идёт под 15° к стене: тумба 708×960 глубиной 493 слева и 300 справа (боковины 493/300 в Базисе), фасады 470+290 под углом, цоколь по косой; пенал 426×1420 глубиной 493→368 с двумя полками; над стеллажом антресоль 250×430 глубиной 364→300. Открытый стеллаж 282×1420×368 с тремя полками. Корпуса на эксцентриках (Базис: стяжка эксц. 15×15). Дверной короб 01 из планок (2467×100/66) не моделируется — это не корпус.",
    project: {
      version: 3, room: room(2600, 2600, 2500), modules: [
        place(mod("Тумба", 708, 960, 493, "Дуб Сонома", { plinthHeight: 80, facadeDecor: "Белый", skew: { side: "right", depth: 300 }, fastening: "eccentric" }, [{ weight: 426, shelves: [0.5] }, { weight: 266, shelves: [0.5] }]), 300, 3),
        place(mod("Пенал", 426, 1420, 493, "Дуб Сонома", { plinthHeight: 0, facadeDecor: "Белый", skew: { side: "right", depth: 368 }, fastening: "eccentric" }, [{ shelves: [0.33, 0.66] }]), 300, 3, 960),
        place(mod("Стеллаж", 282, 990, 368, "Дуб Сонома", { plinthHeight: 0, doors: false, fastening: "eccentric" }, [{ shelves: [0.27, 0.53, 0.8] }]), 726, 3, 960),
        place(mod("Антресоль", 282, 430, 364, "Дуб Сонома", { plinthHeight: 0, facadeDecor: "Белый", skew: { side: "right", depth: 300 }, fastening: "eccentric", hingeSide: "right" }, [{ shelves: [0.55] }]), 726, 3, 1950),
      ],
    },
  },
};
